    ...
    public partial class MainForm : Form
    {
        ...
        private void RunButtonClick(object sender, EventArgs e)
        {
            ...
            else if(heightMapButton.Checked)
            {
                ...
                _start.FileName = @"C:\Users\Mishanya - PC\AppData\Local\Programs\Python\Python39\python.exe";
                //argument with file name and input parameters
                _start.Arguments = string.Format("\"{0}\" \"{1}\" \"{2}\"", Path.Combine(AppDomain.CurrentDomain.BaseDirectory,"..\\..\\..\\..\\", "hello.py"), 5, 10);
                ...
                _start.LoadUserProfile = true;
                using (Process process = Process.Start(_start))
                {
